...
<rules project="Qleaner" version="1.0.0">
  ...
  <section id="devops-reporting">
    ...
    <rule id="DO-03" severity="required">Report each progress on commits via Telegram. BOT_TOKEN: `<YOUR_TELEGRAM_BOT_TOKEN>`. Admin IDs: `1426904527` (keyvan arasteh).</rule>
  </section>
